...
---|---|---|
[translatorstarterkit.txt](https://github.com/simondarksidej/XNAGameStudio/blob/master/Documents/translatorstarterkit.txt?raw=true) | 0.00MB | This program provides the user with the ability to enter a word or phrase in one language and have it translated to another language.
