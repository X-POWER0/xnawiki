...
---|---|---|
[SpaceShooter_ARCHIVE_3_0.zip](https://github.com/simondarksidej/XNAGameStudio/blob/master/Samples/SpaceShooter_ARCHIVE_3_0.zip?raw=true) | 11.71MB | Contains all source and assets for the SpaceShooter Sample (XNA Game Studio 3.0, Archived). 