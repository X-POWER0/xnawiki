...
[*Windows Phone Localization for Games*](https://github.com/DDReaper/XNAGameStudio/wiki/Windows Phone Localization for Games) | Localization & Globalization | This document provides a step-by-step guide and recommended practices to ensure a Windows Phone game project made in XNA Game Studio is localizable. | Article
[*Game State Management (Mango, C#/VB)*](https://github.com/DDReaper/XNAGameStudio/wiki/Game State Management (Mango, C#VB)) | Games: Gameplay, User Experience | This sample shows how to manage the transitions among menus and gameplay states.| Code Sample
[*Paddle Battle (Mango, C#/VB)*](https://github.com/DDReaper/XNAGameStudio/wiki/Paddle Battle (Mango, C#VB)) | Games: 2D Graphics, Games: Gameplay, Games: Graphics, User Experience | This sample shows a very basic game written on top of the new Silverlight/XNA Framework application model. | Code Sample 
