...
This chapter, we will extend our code so the cannon will launch a rocket whenever the spacebar is pressed. Start by downloading the rocket image by clicking here and importing it into your XNA project. Add this variable to the top of our code:
...
Let’s start in our ProcessKeyboard method, we we want to launch the rocket on a keypress. So add this code to the end of the method:
...
For the position, you start at the bottom-left corner of the carriage, and add 20 pixels to the right and 20 pixels up, corresponding to the center of the carriage. As starting angle of the rocket, we should simply take the current angle of the cannon.
