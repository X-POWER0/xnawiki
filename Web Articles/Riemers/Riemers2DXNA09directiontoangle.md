...
This is because the SpriteBatch renders the image rotated by the rocketAngle value, and when we change the rocketDirection we don’t change this value yet. So what we want to know is: given a direction, what is the angle corresponding to this direction?
...
We’re looking for the angle between the direction and the Y axis
In XNA, the Up axis is the negative Y axis
