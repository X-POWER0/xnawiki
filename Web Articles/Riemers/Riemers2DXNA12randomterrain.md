...
To solve this, find the 4 lines that define the positions at the end of our SetUpPlayers method, and delete them. Instead, we will calculate them inside the for-loop of that method, that should look like this:
