...
// Image adding spritefont in MGCB
...
Also, you will be presented with a weird looking text file in your main window. Luckily, there’s not too much we need to change here. Find the FontName entry in the file, and change Segoe UI Mono
to Arial. This will define the font family, and you can choose any font installed on your system. To see which fonts are installed on your system, open the C:/Windows/Fonts folder. Note also that in this text file you can also change the size of your font. By default, the size is set to 14 points.
